def auswerte(dicke, NummerMessung, Kommentar, file_name):
    ...
    amplitudeDet2_chan1_slice = amplitudeDet2_chan2_slice[n:]
    ...
    plt.plot(freqs_slice, amplitudeDet2_chan2_slice, color='orange', label='Detektor 2, channel 2')
    plt.plot(dominantfreqDet2_chan2, maxvalueDet2_chan2, color='orange', marker='*')
